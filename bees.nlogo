...
to worker-action
  ...
  [
    ...
    [
      ifelse carrying != "poisoned-honey" or carrying != "honey" [set current-action "feeding-queen"][set current-action "gathering-honey"]
      ]
    [
      ;;else feed self
      ifelse energy < max-energy-worker
      [
        ifelse carrying = "poisoned-honey" or carrying = "honey"
